  ...
  return (
    <div ref={wrapperRef} className="relative w-full group">
      <form onSubmit={handleSubmit} className="relative flex items-center w-full">
        ...
        <button
          type="submit"
          className="absolute right-2 bg-blue-600 text-white px-6 py-2 rounded-xl text-sm font-black hover:bg-blue-700 transition-all shadow-md shadow-blue-200 dark:shadow-none active:scale-95 uppercase tracking-wider"
        >
          Search
        </button>
      </form>
